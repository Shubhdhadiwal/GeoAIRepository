...
if selected_tab != "Favorites" and selected_tab not in ["About", "Submit New Resource", "FAQ", "Open Buildings Viewer"]:
...
if selected_tab not in ["Favorites", "About", "Submit New Resource", "FAQ", "Open Buildings Viewer"]:
    if search_term:
...
if selected_tab not in ["About", "Submit New Resource", "FAQ", "Open Buildings Viewer"]:
